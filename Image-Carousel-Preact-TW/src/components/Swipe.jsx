...
class Swipe extends React.Component {
    render() {
        ...
        let svg = null;
        if (src === "left") {
            svg = <svg xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF" width="50px" height="50px" viewBox="0 0 24 24">
